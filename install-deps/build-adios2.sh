...
PREFIX=$FLANSOFT/adios2-2.10.1

# delete old checkout and builds
#rm -rf adios2-2.9.2.tar* adios2-2.9.2
rm -rf adios2-2.10.1.tar* adios2-2.10.1
...
mkdir adios2-2.10.1
tar -xvf adios2-2.10.1.tar -C adios2-2.10.1 --strip-components 1
