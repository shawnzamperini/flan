...
if [ -e "$1.cpp" ]; then
	...
	cp /home/zamp/github/flan/regression/blank_input_file.cpp $1.cpp
fi
...
find_package(flan REQUIRED HINTS "/home/zamp/github/flan/lib/cmake")
